...
public class CustomMethodReveiw {
	
	//     declaration of method:
	//     Acces-modifiers  specifier   return-type   methodName ( Parameter ) {
    ...
    // specifier  : static
	// return-type  :  void , all primative and non primative
	// methodName : anyName
	// parameter : all data type
	
	// if the retun type of method is void: method does not return any value.
	//if the retun type of method is  NOT void: method MUST retun a value.

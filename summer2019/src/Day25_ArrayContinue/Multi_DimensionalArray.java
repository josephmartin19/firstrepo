...
public class Multi_DimensionalArray {
    ...
    //  2 dimensional array: array that contains multiple 1 dimensional arrays
        ...
        int[][] arr2D  = {  {1,2,3}  ,  {4,5,6}   };
                      //     0 1 2       0 1 2   ==>   0 index, 1 index, 2 index
...
//[index numbers of 2D array][ index number of 1D array] [ index number of value]
    ...
    String[][] str2D1  =   {  {"A" ,"B"} ,  {"C" ,"D","E"}     };
    System.out.println(  Arrays.toString(str2D1) );          // hash code
    System.out.println(  Arrays.deepToString( str2D1 ) );   // deepToString [A, B], [C, D, E]

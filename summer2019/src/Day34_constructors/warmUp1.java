...
public class warmUp1 {
	 ...
	 *  3. use the above two methods to
	 * write a new method that can find the frequency of characters Ex:
	 * frequency("aabcabcabc") ==>a4b3c3
	 *  4. write a return method that can find the
	 ...
	 */
	 ...
	 public static void main(String[] args) {
	        //task01
	        String a = RemoveDup("aaaaaabbbbbbhhhhh");   // "abh"
